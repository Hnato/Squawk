...
namespace Squawk.Game
{
    public class Parrot
    {
        ...
        public float SpeedBase = 180f;
        public float SpeedBoost = 330f;
        ...
        public string DisplayName = "Gracz";
        ...
        void UpdateSegments()
        {
            ...
            // Struct handling: modify copy then assign back
            var head = Segments[0];
            head.Position = Position;
            head.Radius = Size * 1.05f;
            Segments[0] = head;
